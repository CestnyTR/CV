const TR_NavBarInfo = [
    { id: 1, page: "Hakkımda", link: "about-me" },
    { id: 2, page: "Projelerim", link: "MyProjects" },
    { id: 3, page: "Yeteneklerim", link: "talent" },
    { id: 4, page: "Sertifikalar", link: "certificate" },
    { id: 5, page: "Okul", link: "school" },
    { id: 6, page: "Deneyimlerim", link: "experiences" }
]
const TR_MeInfo = [
...
const TR_VideoProjectInfo = [
    { id: 1, projectName: "Zombi Oyunu", projectID: "ZombieGame" },
    { id: 2, projectName: "2D Platform Oyunu", projectID: "2DPlatformGame" },
    { id: 3, projectName: "3D Unity oyunu", projectID: "3DGame" },
    { id: 4, projectName: "3D UNREAL ENGİNE 5 Jet Uçuş Oyunu", projectID: "UE5JetFlight" },
]
const TR_LinkedProjectInfo = [
    { id: 1, projectName: "Photoshop Tasarımlarım", Link: "https://drive.google.com/drive/folders/1RTy6SjzyMEfllyCWfEzgsJf28Xt7YDAz" },
    { id: 2, projectName: "Java tabanlı kütüphane otomasyon sistemi", Link: "https://github.com/CestnyTR/JavaLibraryOtomation" },
    { id: 3, projectName: "C# çiftlik otomasyon sistemi", Link: "https://github.com/CestnyTR/CiftlikOtomasyon" },
    { id: 4, projectName: "GTA5 rp sunucuları için JS ile hazırlanmış market script", Link: "https://github.com/CestnyTR/GTA5-MARKET-SC" },
    { id: 5, projectName: "Word ile klavuz düzenleme", Link: "https://github.com/CestnyTR/handbookOfWordpress" },
    { id: 6, projectName: "C# ASP.NET ile hazırlanmış Kullanıcı Kayıt/giriş/List sitesi", Link: "https://github.com/CestnyTR/user-registary-inputs" }
...
const TR_experiences = [
    ...
    { id: 5, experiencesTime: "5 Ay", business: " ARCSIM - Formula Simulator, Show Car, Airbus Simulator, Ralli Simulator. Motion Systems", departman: "Bilgi işlem", job: "Bilgisayar Programcısı" },
]
const TR_Contacts = [
